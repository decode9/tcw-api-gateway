...
_DATAPROCESSOR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SaveData',
    full_name='users.DataProcessor.SaveData',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='UpdateData',
    full_name='users.DataProcessor.UpdateData',
    index=2,
    containing_service=None,
    input_type=_DATA,
    output_type=_DATARESPONSE,
